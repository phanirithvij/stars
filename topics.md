...
- [uyuni-project/uyuni](https://github.com/uyuni-project/uyuni) - Open-source systems management and configuration platform
- [keiyoushi/extensions-source](https://github.com/keiyoushi/extensions-source) - Source code of extensions in https://github.com/keiyoushi/extensions
- [UltimMC/Launcher](https://github.com/UltimMC/Launcher) - Offline Minecraft launcher.
- [bee-san/RustScan](https://github.com/bee-san/RustScan) - 🤖 The Modern Port Scanner 🤖
- [rajasegar/awesome-htmx](https://github.com/rajasegar/awesome-htmx) - Awesome things about htmx
...
- [agalwood/Motrix](https://github.com/agalwood/Motrix) - A full-featured download manager.
- [nativefier/nativefier](https://github.com/nativefier/nativefier) - Make any web page a desktop application
- [xyproto/wallutils](https://github.com/xyproto/wallutils) - :city_sunset: Utilities for handling monitors, resolutions, wallpapers and timed wallpapers + display available VRAM
...
- [NixOS/nix-installer](https://github.com/NixOS/nix-installer) - A fork of the Determinate Nix Installer.
...
- [hey-adora/catsquad](https://github.com/hey-adora/catsquad) - 
...
- [nixos-lima/nixos-lima](https://github.com/nixos-lima/nixos-lima) - NixOS VMs on macOS/Linux via Lima
...
- [vorburger/blog](https://github.com/vorburger/blog) - My Public Blog like Notes like Trip Report et al.
...
- [aaronchall/config](https://github.com/aaronchall/config) - My all-in-one config for my computers. You can copy to get yourself started.
...
- [termux-pacman/termux-packages](https://github.com/termux-pacman/termux-packages) - A build system and primary set of packages in format pacman for Termux (repository mirror)
- [termux/termux-packages](https://github.com/termux/termux-packages) - A package build system for Termux.
- [termux/proot](https://github.com/termux/proot) - An chroot-like implementation using ptrace.
- [termux-user-repository/tur](https://github.com/termux-user-repository/tur) - A place for all types of Termux packages.
- [TermuxArch/TermuxArch](https://github.com/TermuxArch/TermuxArch) - Experience the pleasure of the Linux command prompt in Android, Chromebook, Fire OS and Windows on smartphone, smartTV, tablet and wearable https://termuxarch.github.io/TermuxArch/
